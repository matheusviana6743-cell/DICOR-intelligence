...
def _disable_v75(bot_module):
    ...
    async def minimal_startup():
        print("✅ V188: startup pesado desativado; Discord/Core preservados.", flush=True)
...
def install(bot_module):
    ...
    bot_module._v188_safe_create_task = lambda coro, *, name=None: _safe_create_task(coro, name=name)
