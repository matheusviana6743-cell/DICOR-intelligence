# -*- coding: utf-8 -*-
"""Launcher oficial do DICOR Core V606 + Central V705."""
import asyncio
import os
import traceback
import discord
...
async def main():
    ...
    central = central_home_v705.install(bot)
    await central.start()

    print("✅ DICOR Core V606 ativo | BO + Perícia | Central V705", flush=True)
