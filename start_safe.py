# -*- coding: utf-8 -*-
"""Launcher oficial do DICOR Core V606 + Central V628 + Rate Guards V615."""
import asyncio
import os
import traceback
import discord
...
async def main():
    ...
    central = central_visual_v628.install(bot)
    central_rate_guard_v615.install(central)
    await central.start()

    print("✅ DICOR Core V606 ativo | BO + Perícia | Central V628 | logs Central", flush=True)
