# -*- coding: utf-8 -*-
"""Launcher oficial do DICOR Core V606 + Central V611."""
import asyncio
import os
import traceback
...
async def main():
    ...
    central = central_discord_v611.install(bot)
    await central.start()

    print("✅ DICOR Core V606 ativo | BO + Perícia | recuperação limitada | Central V611 rápida", flush=True)
