# -*- coding: utf-8 -*-
"""Launcher oficial do DICOR Core V606 + Central V612."""
import asyncio
import os
import traceback
...
async def main():
    ...
    central = central_discord_v612.install(bot)
    await central.start()

    print("DICOR Core V606 ativo | BO + Perícia | recuperação limitada | Central V612", flush=True)
