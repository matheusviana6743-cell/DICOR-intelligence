# -*- coding: utf-8 -*-
"""Launcher oficial do DICOR Core V606 + Central V704."""
import asyncio
import os
import traceback
import discord
...
async def main():
    ...
    central = central_home_v704.install(bot)
    await central.start()

    print("✅ DICOR Core V606 ativo | BO + Perícia | Central V704", flush=True)
