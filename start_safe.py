# -*- coding: utf-8 -*-
"""Launcher oficial do DICOR Core V606 + Central V631 + Rate Guards V615."""
import asyncio
import os
import traceback
import discord
...
async def main():
    ...
    central = central_visual_v631.install(bot)
    central_rate_guard_v615.install(central)
    await central.start()

    print("✅ DICOR Core V606 ativo | BO + Perícia | Central V631 PC-ONLY | logs Central", flush=True)
